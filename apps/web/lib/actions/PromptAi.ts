...
Purpose: Displays the technologies used in the portfolio.
Key Features: Dynamically lists technologies from data.techStack and presents them in a visually appealing layout.
...
code is in next.js typescript so make sure to use correct format and write 'use client' on top of the file if using any react hooks other wise it will break the application do not write 
